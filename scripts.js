...
function start() {
    ...
    if (teams >= 1) {valid.push(document.getElementById("team1-score")); document.getElementById("team1_button").innerHTML = "<a class='teambutton' href='#'>TEAM 1</a>";}
    if (teams >= 2) {valid.push(document.getElementById("team2-score")); document.getElementById("team2_button").innerHTML = "<a class='teambutton' href='#'>TEAM 2</a>";}
    if (teams >= 3) {valid.push(document.getElementById("team3-score")); document.getElementById("team3_button").innerHTML = "<a class='teambutton' href='#'>TEAM 3</a>";}
    if (teams >= 4) {valid.push(document.getElementById("team4-score")); document.getElementById("team4_button").innerHTML = "<a class='teambutton' href='#'>TEAM 4</a>";}
